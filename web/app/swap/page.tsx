...
export default function Swap() {
  ...
  const connection = new Connection(
    'https://mainnet.helius-rpc.com/?api-key=6d4e5372-fc32-44cd-af0f-58abc499b686'
  );

  console.log("wallet addy", wallet.publicKey?.toString());
  ...
  async function getQuote(currentAmount: number) {
    if (isNaN(currentAmount) || currentAmount <= 0) {
      console.error('Invalid Amount value:', currentAmount);
      return;
    }
